...
PROPERTIES_JSON=` echo $PROMPT | jq -R '{properties:{prompt:.}}' `
...
CREATE_DOCUMENTS_EP_COMMAND_JSON=` echo $JSON | ./rest-ep-json.bash $DOCUMENTS_EP_NAME $DOCUMENTS_PORT | ./rest-ep-curl-command.bash `
